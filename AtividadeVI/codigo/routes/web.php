...
Route::prefix('clientes')->group(function () {
    ...
    Route::get('/showvenda',[ClienteController::class, 'showvenda']);
});

Route::prefix('fornecedores')->group( function () {
    Route::get('/indexs',[FornecedorController::class, 'indexs'])->name('fornecedores.indexs');
    ...
    Route::get('/showentrada',[FornecedorController::class, 'showentrada']);
});
