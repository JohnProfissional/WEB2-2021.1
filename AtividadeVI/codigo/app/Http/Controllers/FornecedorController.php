...
class FornecedorController extends Controller
{
   ...
   public function indexs(){
    ...
    public function store(StoreFornecedorRequest $request){
        ...
        $fornecedor->save();
        return redirect()->route('fornecedores.indexs');
    }
    ...
    public function update (StoreFornecedorRequest $request){
        ...
        return redirect()->route('fornecedores.indexs')->with('msg', 'Alteração realizada com sucesso');
    }

    public function destroy ($id){
        Fornecedor::findorfail($id)->delete();
        return redirect()->route('fornecedores.indexs')->with('msg', 'Fornecedor apagado');
    }
