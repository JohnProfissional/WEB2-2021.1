...
class VendaController extends Controller
{
    ...
    public function store(StoreVendaRequest $request){
        ...
        $venda->save();
        return redirect()->route('venda.indexvenda');
    }
    ...
    public function update (StoreVendaRequest $request){
        ...
        return redirect()->route('venda.indexvenda')->with('msg', 'Alteração realizada com sucesso');
    }

    public function destroy ($id){
        Venda::findorfail($id)->delete();
        return redirect()->route('venda.indexvenda')->with('msg', 'Venda apagada');
    }
