...
class ProdutoController extends Controller
{
    ...
    public function indexproduto(){
       ...
       public function store(StoreProdutoRequest $request){
        ...
        $produto->save();
        return redirect()->route('produtos.indexproduto');
    }
    ...
    public function update (StoreProdutoRequest $request){
        ...
        return redirect()->route('produtos.indexproduto')->with('msg', 'Alteração realizada com sucesso');
    }

    public function destroy ($id){
        Produto::findorfail($id)->delete();
        return redirect()->route('produtos.indexproduto')->with('msg', 'Produto apagado');
    }
