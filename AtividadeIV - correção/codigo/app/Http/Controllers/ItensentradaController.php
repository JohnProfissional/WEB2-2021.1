...
class ItensentradaController extends Controller
{
    ...
    public function update (Request $request){
        ...
        return redirect('itensentrada/indexitensentrada')->with('msg', 'Alteração realizada com sucesso');
    }

    public function destroy ($id){
        Itensentrada::findorfail($id)->delete();
        return redirect('itensentrada/indexitensentrada')->with('msg', 'Itens entrada apagados');
    }
}
